        ...
        <div class="breadcrumbs">
					...
					<tbody>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="{{URL::to('public/uploads/sanpham/'.$v_content->options->image)}}" height="90" width="90" alt=""></a>
							</td>
            ...
            <form action="{{URL::to('/order-place')}}" method="POST">
                ...
                <div class="payment-options" >
                        <span>
                            <label><input   name="payment_option" value="1" type="radio" required=""> Thanh toàn bằng thẻ ATM</label>
                        </span>
                        <span>
                            <label><input   name="payment_option" value="2" type="radio" required=""> Thanh toán tiền mặt</label>
                        </span>
                        <!-- <span>
                            <label><input type="checkbox"> Paypal</label>
                        </span> -->
                        <input type="submit" value="Thanh toán" name="update_qty" class="btn btn-primary btn-sm" >
                </div>
            </form>
		</div>
	</section> <!--/#cart_items-->
